...
| 标签 | 提交 | 说明 |
|------|------|------|
| `v1.6.7` | `8456a92` | **最新** — OpenCode 1.18.27（跳过 v1.6.5/v1.6.6）|
| `v1.6.4` | `8feb840` | OpenCode 1.18.25 |
| `v1.5.8` | `2c90b14` | OpenCode 1.18.18 |
| `v1.5.7` | `cead61e` | OpenCode 1.18.17 |
| `v1.5.6` | `3c347af` | OpenCode 1.18.16 |
| `v1.5.5` | `f79d7d9` | OpenCode 1.18.15 |
| `v1.5.4` | `ec22bf4` | OpenCode 1.18.14 |
| `v1.5.3` | `7ba885a` | OpenCode 1.18.13 |
| `v1.5.2` | `f101837` | OpenCode 1.18.12 |
| `v1.5.1` | `edf1d47` | OpenCode 1.18.11 |
| `v1.5.0` | `9f9591b` | 移除 webui 死配置 |
| `v1.4.2` | `4d2a51c` | OpenCode 1.18.10 |
| `v1.4.1` | `ce74241` | OpenCode 1.18.9 |
| `v1.4.0` | `890f09c` | OpenCode 1.18.7 |
| `v1.3.9` | `60085c8` | OpenCode 1.18.5 |
| `v1.3.8` | `9a95d48` | OpenCode 1.18.4 |
| `v1.3.7` | `285ed05` | OpenCode 1.18.3 |
| `v1.3.6` | `bde4ddc` | OpenCode 1.18.2 |
| `v1.3.5` | `4f6187e` | 删除 discoverWorkspacesViaDb 死代码 |
| `v1.3.4` | `78a98c3` | OpenCode 1.18.1 |
| `v1.3.3` | `0cfe721` | OpenCode 1.17.20 |
| `v1.3.2` | `130656d` | OpenCode 1.17.18 |
| `v1.3.1` | `ea66d5a` | OpenCode 1.17.14 |
| `v1.3.0.1` | `2c6184a` | lock 同步 SDK 1.17.13 |
| `v1.3.0` | `3b69232` | OpenCode 1.17.13，SDK 版本升级 |
| `v1.2.9` | `198a348` | OpenCode 1.17.12，SDK 客户端方法扩展 |
| `v1.2.8` | `729963c` | OpenCode 1.17.11，适配 SDK v2 |
